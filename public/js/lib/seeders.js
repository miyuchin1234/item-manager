...
const saveTestData = () => {
  let json = JSON.stringify([
    {sku: 'A001', category: '本', name: 'PC通信', manufacturer: '文教堂書店', releaseDate: '2022/06/22', price: 890, value: 'book'},
    {sku: 'A002', category: '家電', name: '掃除機', manufacturer: 'Toshiba', releaseDate: '2020/08/22', price: 25000, value: 'consumer-electronics'},
    {sku: 'A003', category: '食品', name: 'バナナ', manufacturer: 'ドール', releaseDate: '2022/06/22', price: 150, value: 'food'},
    {sku: 'A004', category: 'ファッション', name: 'Tシャツ', manufacturer:'ユニクロ', releaseDate:'2021/05/22', price: 1500, value: 'fashion'},
    {sku: 'A005', category: '本', name: 'vogue', manufacturer: '公文社', releaseDate: '2022/10/02', price: 1080,value: 'book'},
    ...
    {sku: 'A016', category: '家電', name: 'エアコン', manufacturer: 'ダイキン', releaseDate: '2020/08/22', price: 89800, value: 'consumer-electronics'},
